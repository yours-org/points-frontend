...
* @returns {Solution}
*/
export function mine(txid, difficulty, work_size) {
    const ptr0 = passStringToWasm0(txid, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.mine(ptr0, len0, difficulty, work_size);
...
export class Solution {
    ...
    */
    get hash() {
        ...
        try {
            ...
            wasm.solution_hash(retptr, this.__wbg_ptr);
    ...
    */
    get nonce() {
        ...
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.solution_nonce(retptr, this.__wbg_ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            deferred1_0 = r0;
            deferred1_1 = r1;
...
export const __wbg_random_195f5613d058d092 = typeof Math.random == 'function' ? Math.random : notDefined('Math.random');
